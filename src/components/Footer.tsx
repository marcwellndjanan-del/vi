...
import { GraduationCap, Facebook, Instagram, Linkedin, Send } from "lucide-react";
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <p className="text-sm text-muted-foreground">
              Your AI-powered scholarship discovery platform. Find opportunities that match your profile.
            </p>
          </div>
